function Hpsi = Imaginary_time_iteration_sphere_single_component( ...
    psi, ...
    m_a, ...
    g_a, ...
    N_a, ...
...
% IMAGINARY_TIME_ITERATION_SPHERE_SINGLE_COMPONENT
% Compute H psi for a single-component GPE on a sphere.
%
% INPUTS
%   psi      : wavefunction of the single component
%   m_a      : mass
...
%
% OUTPUT
%   Hpsi     : Hamiltonian applied to psi
