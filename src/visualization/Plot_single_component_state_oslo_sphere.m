function fig = Plot_single_component_state_oslo_sphere(psi, L_band, method, varargin)
%PLOT_FRAME_SINGLE_COMPONENT_SPHERE_OSLO
% Plot density and phase of a single wavefunction on the sphere.
%
% Same as Plot_single_component_state_sphere, but using the custom inverted
% oslo colormap for the density panel.
%
% INPUTS
%   psi     : wavefunction
